...
from getall.cli import commands
...
def mock_prompt_session():
    ...
    with patch("getall.cli.commands._PROMPT_SESSION", mock_session):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("getall.cli.commands.PromptSession") as MockSession, \
         patch("getall.cli.commands.FileHistory") as MockHistory, \
